      ...
      <div className='md:flex gap-4 py-2'>
        ...
        <div className='md:w-1/2'>
          <div className='flex gap-3 bg-slate-300 w-36 px-2 items-center rounded-full '>
            <p className='text-xs font-medium text-slate-900'>Food Delivery</p>
          ...
          <p className='py-3 text-base'>In today's fast-paced world, the convenience of online shopping has revolutionized the way we purchase goods and services. The e-commerce industry has expanded into various domains, including the sale of fresh fruits, vegetables, and other products.Shopping online for fruits, vegetables, and other products saves customers time that would otherwise be spent traveling to physical stores.</p>
